    ...
    >
      <div className={classes.container}>
        <div className={classes.content}>
          ...
          <p>
            Offering a wide range of musculoskeletal (MSK) services in
            Gloucester.
          </p>
          <p>
            If you are seeking high quality, professional and reliable
            care to guide you through your rehabilitation process,
            please contact us.
          </p>
